...
class Main_window(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('VFS Draw Generator')
        self.resize(600, 400)

        label = QLabel('Choose a discipline:')
...
class Window_1(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('VFS 2-way Draw Generator')
        self.resize(450, 400)

        label_win_1 = QLabel('Choose a class:')
        self.button_win_1_1 = QPushButton('Inter')
        self.button_win_1_2 = QPushButton('A-class')
        self.button_win_1_3 = QPushButton('Open')
        self.button_win_1_4 = QPushButton('back')
...
class Inter_window(QWidget):
    ...
    def initUI(self):
        ...
        self.label_win_inter = QLabel('; '.join(results[0]) + "\n" + '; '.join(results[1]) + "\n" +
                                      '; '.join(results[2]) + "\n" + '; '.join(results[3]) + "\n" +
                                      '; '.join(results[4]))
        self.button_win_inter_1 = QPushButton('Generate again')
        self.button_win_inter_2 = QPushButton('back')
...
class Aclass_window(QWidget):
    ...
    def initUI(self):
        ...
        self.label_win_aclass = QLabel('; '.join(results[0]) + "\n" + '; '.join(results[1]) + "\n" +
                                       '; '.join(results[2]) + "\n" + '; '.join(results[3]) + "\n" +
                                       '; '.join(results[4]))
        self.button_win_aclass_1 = QPushButton('Generate again')
        self.button_win_aclass_2 = QPushButton('back')
...
class Open_window(QWidget):
    ...
    def initUI(self):
        ...
        self.label_win_open = QLabel('; '.join(results[0]) + "\n" + '; '.join(results[1]) + "\n" +
                                     '; '.join(results[2]) + "\n" + '; '.join(results[3]) + "\n" +
                                     '; '.join(results[4]) + "\n" + '; '.join(results[5]))
        self.button_win_open_1 = QPushButton('Generate again')
        self.button_win_open_2 = QPushButton('back')
...
class Window_2(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('VFS 4-way Draw Generator')
        self.resize(450, 400)
        ...
        self.label_win_2 = QLabel('; '.join(results[0]) + "\n" + '; '.join(results[1]) + "\n" +
                                  ...
                                  '; '.join(results[6]) + "\n" + '; '.join(results[7]) + "\n" +
                                  '; '.join(results[8]) + "\n" + '; '.join(results[9]))
        self.button_win_2_1 = QPushButton('Generate again')
        self.button_win_2_2 = QPushButton('back')
